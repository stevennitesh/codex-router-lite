...
const validCommands = new Set(["enable", "disable", "status", "caller-capability-refresh"]);
if (!validCommands.has(command)) {
  console.error("Usage: config-manager.mjs enable|disable|status|caller-capability-refresh");
  process.exit(2);
}
