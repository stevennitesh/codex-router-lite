...
| Protected OpenRouter credential and final outbound validation | `src/api-forwarder.mjs` |
...
The forwarder repeats final route validation and Union parameter filtering at
...
map from one list. Product-boundary checks and the Windows package manifest stay
