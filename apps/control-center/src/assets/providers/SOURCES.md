...
| `stealth.svg` | Codenamed preview models with no maker's mark of their own (Fugu Ultra and Inkling), and the user-defined Custom provider | n/a | Original artwork drawn for this repository; not a third-party mark |
