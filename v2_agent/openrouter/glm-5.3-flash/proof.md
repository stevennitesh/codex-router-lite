...
| Function call | pass | The endpoint declined forced selection, then returned the offered `codex_router_probe` call with valid JSON arguments and HTTP 200. The route therefore normalizes required and named-function selection to `auto`. |
